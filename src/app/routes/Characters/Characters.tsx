...
const Characters = () => {
    ...
    const characterPortraits = useCharacterInfos().map((characterInfo) => {
        ...
        return <CharacterIconButton isSelected={isSelected} key={characterInfo.id} characterId={characterInfo.id} onClick={() => onCharacterPortraitClicked(characterInfo.id)} />
    })
