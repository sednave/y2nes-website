...
const Homepage = () => {
    ...
    const newsSection = (
        <section id="news-section">
            <div id="news-grid">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/o7Er2Xo82aU?si=X9y4xYL2a0HcAI61" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                <div>
                    <h2>News</h2>
