...
const MusicListing = ({listingId, style}: Props) => {
    ...
    switch (listingId) {
        ...
        case "Break! The Scarlet Devil!":
            inner = <>
                <iframe className="bandcamp-player" src="https://bandcamp.com/EmbeddedPlayer/album=3392606553/size=large/bgcol=ffffff/linkcol=0687f5/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/album/break-the-scarlet-devil">Break! The Scarlet Devil! by Y2NES</a></iframe>
        ...
        case "STARDUSTER":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/album=3660575711/size=large/bgcol=ffffff/linkcol=0687f5/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/album/starduster">STARDUSTER by Y2NES</a></iframe>
                <h2>STARDUSTER</h2>
        ...
        case "FREEFALL":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/album=2224695440/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/album/freefall">FREEFALL by Y2NES</a></iframe>
                <h2>FREEFALL</h2>
        ...
        case "STARLIGHT EYES":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/track=3164590948/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/track/starlight-eyes-2">STARLIGHT EYES by Y2NES</a></iframe>
        ...
        case "MAX POWER (feat. Space Bwoi)":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/track=3356116089/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/track/max-power-feat-space-bwoi">MAX POWER (feat. Space Bwoi) by Y2NES</a></iframe>
        ...
        case "AIN'T MOVING":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/track=2069550112/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/track/aint-moving">AIN&#39;T MOVING by Y2NES</a></iframe>
                <h2>AIN'T MOVING</h2>
        ...
        case "CONTINUE THE BROADCAST":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/track=3257326075/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/track/continue-the-broadcast">CONTINUE THE BROADCAST by Y2NES</a></iframe>
        ...
        case "KNOW I'M A KING":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/track=2100894274/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/track/know-im-a-king">KNOW I&#39;M A KING by Y2NES</a></iframe>
        ...
        case "LET IT BUBBLE UP":
            inner = <>
                <iframe className='bandcamp-player' src="https://bandcamp.com/EmbeddedPlayer/album=392278578/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="https://y2nes.bandcamp.com/album/let-it-bubble-up">LET IT BUBBLE UP by Y2NES</a></iframe>
        ...
        case "Test Track 1":
            inner = <>
                <iframe width="1230" height="692" src="https://www.youtube.com/embed/uQP803hSnO4" title="literally my first song ever" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                <h2>Test Track 1</h2>
    ...
    return <div className='music-listing' style={style} >
        <div ref={ref}>
            {inner}
        </div>
    </div>
